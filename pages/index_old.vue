<template>
<div class="grid">
  <square-tile type="img" :img-src="'/imgs/self-csgf.jpg'"></square-tile>
  ...
  <square-tile type="img"
    :img-src="'/imgs/logos/harvard-seas-logo-light.svg'"></square-tile>
  ...
  <square-tile type="img"
    :img-src="'imgs/research/kilobots2.jpg'"></square-tile>
