    ...
    <div>
      ...
      >
        <div>
          ...
          <icon-link icon="file-document-box-multiple" to="https://docs.juliaebert.com/projects/3d-print-brain">Read everything</icon-link>
        </div>
      </project>
      ...
      <project is-mockup :img-src="'/imgs/projects/blurber-mockup.png'" title="Blurber">
        <div>
          ...
          <icon-link icon="github-circle" :to="'https://github.com/jtebert/blurber'">View on GitHub</icon-link>
        </div>
      </project>
    </div>
  </primary-section>
