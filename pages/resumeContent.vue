    ...
    <resume-header
      ...
      :links="[
        { to: 'https://juliaebert.com', icon: 'web', text: 'juliaebert.com' },
        {
          ...
          icon: 'email',
          text: 'julia@juliaebert.com',
        },
        {
          to: 'https://github.com/jtebert',
          icon: 'github',
          text: 'github.com/jtebert',
        },
        {
    ...
    <div class="block-content content">
      ...
      <cv-entry
        ...
        :tasks="[
          ...
          'Develop robust path planning (A*, RL) and execution systems for autonomous underwater navigation on complex surfaces, addressing challenges of limited sensing and harsh operating conditions.',
          'Design and implement robot control systems, safety mechanisms, and a robust logging system.',
          'Manage a team of 3 software engineers and supervise interns.',
      ...
      <cv-entry
        ...
        :tasks="[
          ...
          'Collaborated with MIT Media Lab to create heterogeneous robot swarm for inspection on space stations, including algorithm development and hardware testing in microgravity.',
          'Supervised undergraduate and masters research, and taught robotics and digital fabrication courses.',
      ...
      <!-- <cv-entry
        ...
        subtitle="Post-graduate Researcher"
        dates="2015 -- 2016"
        :tasks="[
          'Developed human-robot co-control of the LOPES exoskeleton in standing and walking balance recovery, and modeled in Simulink. Demonstrated balance improvements with human participants.',
        ]"
      ></cv-entry> -->
      <!-- <cv-entry
        location="Boston, MA"
        ...
        :tasks="[
          'Programmed HapticMaster robot (C++) to simulate objects with complex internal dynamics, and evaluated how humans control them, resulting in two publications.',
          'Designed, programmed, conducted, and analyzed experiments to assess ability of humans to learn and retain a motor task with rhythmic and discrete components.',
        ]"
      ></cv-entry> -->
      <!-- <cv-entry
      ...
      <cv-skill
        ...
        category="Outreach"
        :skills="[
          'NPR <i>Brains On</i> podcast guest',
          'FIRST Lego League judge',
          'Harvard <i>Science in the News</i> public lecture',
        ]"
      />
      <cv-skill
        class="is-screen-only"
      ...
      <p class="is-screen-only">
        You can view all my publications on the
